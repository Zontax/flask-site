...
rating_posts = db.Table(
    'rating_posts', db.Column('liked_id', db.Integer,
                              db.ForeignKey('user.id')),
...
class User(UserMixin, db.Model):
    ...
    last_seen = db.Column(db.DateTime,
                          default=datetime.utcnow)  # Останній сеанс
